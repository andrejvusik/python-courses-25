...
last_name, first_name, patronymic = input("What is your last name? "), input("What is your first name? "), input(
    "What is your patronymic? ")

formatted_full_name = last_name.capitalize() + " " + first_name[0].upper() + "." + patronymic[0].upper() + "."
