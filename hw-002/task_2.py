...
user_numbers_list = [float(number) for number in input("Enter a list of numbers: ").split()]

unique_number_list = [number for number in user_numbers_list if user_numbers_list.count(number) == 1]

repeating_number_list = {number for number in user_numbers_list if user_numbers_list.count(number) > 1}

even_number_list = {number for number in user_numbers_list if not number % 1 and not number % 2}
odd_number_list = {number for number in user_numbers_list if not number % 1 and number % 2}
...
largest_number = int(max(user_numbers_list)) if not max(user_numbers_list) % 1 else max(user_numbers_list)

smallest_number = int(min(user_numbers_list)) if not min(user_numbers_list) % 1 else min(user_numbers_list)
