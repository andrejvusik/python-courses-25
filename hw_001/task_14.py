...
first_number_list = [
    dict_roman_numbers[first_roman_number_tuple[i]]
    for i in range(len(first_roman_number_tuple))
]
second_number_list = [
    dict_roman_numbers[second_roman_number_tuple[i]]
    for i in range(len(second_roman_number_tuple))
]
...
if len(first_number_list) <= 1:
    ...
    for el in range(len(first_number_list)):
        if el == 0 and first_number_list[el] >= first_number_list[el + 1]:
            ...
            first_number_list[el + 1]
            and first_number_list[el - 1]
            > first_number_list[el]
            < first_number_list[el + 1]
        ):
            first_number -= first_number_list[el]
        elif (
...
if len(second_number_list) <= 1:
    ...
    for el in range(len(second_number_list)):
        if el == 0 and second_number_list[el] >= second_number_list[el + 1]:
            ...
            second_number_list[el + 1]
            and second_number_list[el - 1]
            > second_number_list[el]
            < second_number_list[el + 1]
        ):
            second_number -= second_number_list[el]
        elif (
...
for i in range(len(difference_tuple)):
    difference_roman = (
        str(table_roman_tuple[i][int(difference_tuple[i])]) + difference_roman
    )
...
print(
    "(", first_number, " - ", second_number, " = ", difference_of_numbers, ")", sep=""
)
